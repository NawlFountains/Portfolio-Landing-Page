  ...
  return (
    <div className='text-white'>
        <div className="fixed inset-0 -z-10">
            <div className='absolute inset-0 bg-gruv-fg2'></div>
            <div className="absolute inset-0 bg-[radial-gradient(circle,_rgba(60,56,54,0.35)_1px,_transparent_1px)] bg-[size:24px_24px]" />
        </div>
